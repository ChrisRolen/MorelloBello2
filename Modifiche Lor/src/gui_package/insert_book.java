...
public class insert_book extends javax.swing.JPanel {
    ...
    Utenti utente;
    JFrame frame;
    public insert_book(Utenti utente,JFrame frame) {
        initComponents();
        this.utente=utente;
        this.frame=frame;
    }
    ...
    private void invioMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_invioMouseClicked
        ...
        try {
            ...
            Libri.new_book(utente, titolo.getText(), autori.getText(), casa_produttrice.getText(), Integer.parseInt(anno_pubblicazione.getText()), ISBN.getText(), generi.getText(), Float.parseFloat(prezzo.getText()), descrizione.getText(), Integer.parseInt(punti_libro.getText()));
